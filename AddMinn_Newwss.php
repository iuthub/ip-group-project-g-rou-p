...
<head>
	...
	.in-second input[type=text]{
        ...
        .in-second input[type="text"]{
        	...
        	margin-top: 40px;
        	font-size: 16px;
        	border:1px solid rgb(181,179,177);
        }
       ...
       .in-second input[type="text"]:focus{
       	border: 1px solid rgb(232,124,19);
        	outline: none;
       }
       .btn-submit{
       	outline: none;
...
<body>
	...
	<div class="in-second">
		...
		<div class="fileUpload" style="margin-top: 10px;margin-bottom: 10px;">
			<input type="file" name="image" class="upload">
		</div>

		<div>
			<textarea name="text" cols="40" rows="4" placeholder="Say smth about this image.." class="txt"></textarea>
		</div>

		<div>
			<input type="hidden" name="id" id="id">
			<input type="submit" name="upload" value="Upload Image" class="btn-submit">
		</div>
